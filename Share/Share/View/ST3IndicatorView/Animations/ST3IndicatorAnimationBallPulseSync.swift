...
class ST3IndicatorAnimationBallPulseSync: ST3IndicatorAnimationDelegate {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw circles
        for i in 0 ..< 3 {
            let circle = ST3IndicatorShape.circle.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
